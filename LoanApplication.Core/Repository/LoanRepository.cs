...
namespace LoanApplication.Core.Repository
{
    public class LoanRepository:ILoanRepository
    {
        ...
        public LoanType LoanType { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        public float Rate { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
